...
if (Meteor.isServer) {
  describe('notes', function () {
    ...
    it('should not remove note if unauthentiated', function () {
      expect(() => {
    ...
    it('should update note', function () {
      const title = 'This is an update title';
    ...
    it('should throw error if extra updates provided', function () {
      expect(() => {
        Meteor.server.method_handlers['notes.update'].apply({
          ...
          noteOne._id,
          { title: 'new title', name: 'Tanutsorn' }
        ]);
      }).toThrow();
    });
    ...
    it('should not update note if unauthentiated', function () {
      expect(() => {
